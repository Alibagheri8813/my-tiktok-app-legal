...
from trader_bot.mt5_client import (
	initialize_mt5, shutdown_mt5, fetch_rates, timeframe_to_str,
	compute_volume_for_risk, place_market_order, format_price
)
from trader_bot.hs_detector import DetectorConfig, detect_head_shoulders, HeadShouldersPattern
from trader_bot.ui_panel import PatternTableUI
